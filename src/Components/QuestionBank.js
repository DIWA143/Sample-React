function getQuestionBank() {
    return [
        ...
        {
            id: 6,
            question: "What is capital of Andra Pradesh?",
            options: ["Amaravathi", "VishakaPattana", "Vizag", "Nandyala"],
            answer: "Amaravathi"
        },
        {
            id: 7,
            question: "What is capital of Telangana?",
            options: ["Amaravathi", "Hyderbad", "Vizag", "Ananthapura"],
            answer: "Hyderbad"
        },
        {
            id: 10,
            question: "What is capital of Karnataka?",
            options: ["Bengaluru", "Hubli", "Mysuru", "Davanagere"],
            answer: "Bengaluru"
        },
